...
const properties_yb171 = (
    ...
    full_level_structure = OrderedDict(
        ...
        "S1/2f=0" => (n = 6, l = 0, j = 1 // 2, f = 0, E = -9.48210909315e9u"1/s"),
        "S1/2f=1" => (n = 6, l = 0, j = 1 // 2, f = 1, E = 3.16070303105e9u"1/s"),
        "D3/2f=0" => (n = 5, l = 2, j = 3 // 2, f = 1, E = 6.88342460964640e14u"1/s"),
        "D3/2f=1" => (n = 5, l = 2, j = 3 // 2, f = 2, E = 6.88350470564640e14u"1/s"),
        "D5/2f=2" => (n = 5, l = 2, j = 5 // 2, f = 2, E = 7.29477895985202e14u"1/s"),
        "D5/2f=3" => (n = 5, l = 2, j = 5 // 2, f = 3, E = 7.29474121985202e14u"1/s"),
        "P1/2f=0" => (n = 6, l = 1, j = 1 // 2, f = 0, E = 8.112913749003559e14u"1/s"),
        "P1/2f=1" => (n = 6, l = 1, j = 1 // 2, f = 1, E = 8.112934798003559e14u"1/s"),
        "[3/2]1/2f=0" =>
            (n = 6, l = nothing, j = 1 // 2, f = 0, E = 1.008917341058788e15u"1/s"),
        "[3/2]1/2f=1" =>
            (n = 6, l = nothing, j = 1 // 2, f = 1, E = 1.008917341058788e15u"1/s"),
        "[3/2]3/2f=1" =>
            (n = 6, l = nothing, j = 3 // 2, f = 1, E = 8.621425511314839e14u"1/s"),
        "[3/2]3/2f=2" =>
            (n = 6, l = nothing, j = 3 // 2, f = 2, E = 8.621425511314839e14u"1/s"),
        "[5/2]5/2f=2" =>
            (n = 6, l = nothing, j = 5 // 2, f = 2, E = 9.70461163716380e14u"1/s"),
        "[5/2]5/2f=3" =>
            (n = 6, l = nothing, j = 5 // 2, f = 3, E = 9.70461163716380e14u"1/s"),
        "F7/2f=3" => (n = 6, l = 3, j = 7 // 2, f = 3, E = 6.42115934728750e14u"1/s"),
        "F7/2f=4" => (n = 6, l = 3, j = 7 // 2, f = 4, E = 6.42119554728750e14u"1/s"),
    ),
    full_transitions = Dict(
        # Laser lines
        # 411nm
        ("S1/2f=0", "D5/2f=2") => (multipole = "E2", einsteinA = 22u"1/s"),
        ("S1/2f=1", "D5/2f=2") => (multipole = "E2", einsteinA = 22u"1/s"),
        ("S1/2f=1", "D5/2f=3") => (multipole = "E2", einsteinA = 22u"1/s"),
        # 369nm
        ("S1/2f=0", "P1/2f=1") => (multipole = "E1", einsteinA = 1.155e8u"1/s"),
        ("S1/2f=1", "P1/2f=0") => (multipole = "E1", einsteinA = 1.155e8u"1/s"),
        ("S1/2f=1", "P1/2f=1") => (multipole = "E1", einsteinA = 1.155e8u"1/s"),
        # 935nm
        ("D3/2f=1", "[3/2]1/2f=0") => (multipole = "E1", einsteinA = 1.2e5u"1/s"),
        ("D3/2f=1", "[3/2]1/2f=1") => (multipole = "E1", einsteinA = 1.2e5u"1/s"),
        ("D3/2f=2", "[3/2]1/2f=1") => (multipole = "E1", einsteinA = 1.2e5u"1/s"),
        # 760nm
        ("F7/2f=3", "[3/2]3/2f=1") => (multipole = "E2", einsteinA = 5e4u"1/s"),
        ("F7/2f=3", "[3/2]3/2f=2") => (multipole = "E2", einsteinA = 5e4u"1/s"),
        ("F7/2f=4", "[3/2]3/2f=2") => (multipole = "E2", einsteinA = 5e4u"1/s"),
        # 638nm
        # 976nm
        # 861nm
        # Decay lines
        # P1/2 -> D3/2
        ("P1/2f=0", "D3/2f=1") => (multipole = "E1", einsteinA = 5.7e5u"1/s"),
        ("P1/2f=1", "D3/2f=2") => (multipole = "E1", einsteinA = 5.7e5u"1/s"),
        ("P1/2f=1", "D3/2f=2") => (multipole = "E1", einsteinA = 5.7e5u"1/s"),
        # [3/2]1/2 -> S1/2
        ("[3/2]1/2f=0", "S1/2f=1") => (multipole = "E1", einsteinA = 8.05e7u"1/s"),
        ("[3/2]1/2f=1", "S1/2f=0") => (multipole = "E1", einsteinA = 8.05e7u"1/s"),
        ("[3/2]1/2f=1", "S1/2f=1") => (multipole = "E1", einsteinA = 8.05e7u"1/s"),
        # [3/2]3/2 -> S1/2
        ("[3/2]1/2f=0", "S1/2f=1") => (multipole = "E1", einsteinA = 5.125e7u"1/s"),
        ("[3/2]1/2f=1", "S1/2f=0") => (multipole = "E1", einsteinA = 5.125e7u"1/s"),
        ("[3/2]1/2f=1", "S1/2f=1") => (multipole = "E1", einsteinA = 5.125e7u"1/s"),
    ),
    # Optional fields
