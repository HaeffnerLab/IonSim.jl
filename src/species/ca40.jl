...
const properties_ca40 = 
    SpeciesProperties(;
        ...
        transitions=Dict(
            (ls"4²S_1/2", ls"3²D_5/2") => (multipole="E2", einsteinA=8.562e-1),
            (ls"4²S_1/2", ls"4²P_1/2") => (multipole="E1", einsteinA=1.299e8),
            (ls"3²D_3/2", ls"4²P_1/2") => (multipole="E1", einsteinA=1.060e7),
            (ls"4²S_1/2", ls"3²D_3/2") => (multipole="E2", einsteinA=9.259e-1),
            (ls"4²S_1/2", ls"4²P_3/2") => (multipole="E1", einsteinA=1.351e8),
            (ls"3²D_3/2", ls"4²P_3/2") => (multipole="E1", einsteinA=1.110e6),
            (ls"3²D_5/2", ls"4²P_3/2") => (multipole="E1", einsteinA=9.901e6),
        ),

        # Optional fields
        gfactors=Dict(
            ls"4²S_1/2" => 2.00225664, 
            ls"3²D_5/2" => 1.2003340
        )
