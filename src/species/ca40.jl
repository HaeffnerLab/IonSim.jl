...
const properties_ca40 = (mass = PhysicalConstant(6.635943757345042e-26, "kg"),
                         ...
                         full_transitions = Dict(("S1/2", "D5/2") => (type="E2", rate=8.562e-1),
                                                 ("S1/2", "P1/2") => (type="E1", rate=1.299e8),
                                                 ("D3/2", "P1/2") => (type="E1", rate=1.060e7),
                                                 ("S1/2", "D3/2") => (type="E2", rate=9.259e-1),
                                                 ("S1/2", "P3/2") => (type="E1", rate=1.351e8),
                                                 ("D3/2", "P3/2") => (type="E1", rate=1.110e6),
                                                 ("D5/2", "P3/2") => (type="E1", rate=9.901e6),
                                                ),
